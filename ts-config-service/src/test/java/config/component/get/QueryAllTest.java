...
public class QueryAllTest {
    ...
    /**
     * <ul>
     * <li><b>Tests:</b></li> that all stored Configs are returned on endpoint call
     * <li><b>Parameters:</b></li> none
     * <li><b>Expected result:</b></li> status 1, msg "Find all content", Array of all Configs
     * </ul>
     * @throws Exception
     */
    @Test
     ...
     * <li><b>Parameters:</b></li> none
     * <li><b>Expected result:</b></li> status 0, msg "No content", empty list of Configs
     * </ul>
     * @throws Exception
     */
    @Test
