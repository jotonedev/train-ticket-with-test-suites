...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    /**
     * allow cors domain header  By default, only six fields can be taken from the header, and the other fields can only
     * be specified in the header. credentials   Cookies are not sent by default and can only be true if a Cookie is
     * needed Validity of this request
     *
