...
public class OrderOtherController
{
    ...
    {
        OrderOtherController.LOGGER.info("[Order Other Service][Get Sold Ticket] Date: {}",
    ...
    {
        OrderOtherController.LOGGER.info("[Order Other Service][Create Order] Create Order form {}  ---> {} at {}",
    ...
    public HttpEntity calculateSoldTicket(@PathVariable String travelDate, @PathVariable String trainNumber,
        ...
        OrderOtherController.LOGGER.info("[Order Other Service][Calculate Sold Tickets] Date: {} TrainNumber: {}",
