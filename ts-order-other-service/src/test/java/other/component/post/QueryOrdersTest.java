...
public class QueryOrdersTest {
    ...
    /**
     * <ul>
     * <li><b>Tests:</b></li> that the endpoint for checking if the orders fit the requirements works correctly, for a valid order information
     * where the login ID matches an account ID of orders in the database.
     * <li><b>Parameters:</b></li> a valid orderInfo object
     * <li><b>Expected result:</b></li> status 1, msg "Get order num", a list of orders
     * </ul>
     * @throws Exception
     */
    @Test
    public void testQueryOrdersCorrectObject() throws Exception {
        // Arrange
        ...
        // Act
        String result = mockMvc.perform(post("/api/v1/orderOtherService/orderOther/query")
     ...
     * <li><b>Expected result:</b></li> status 1, msg "Get order num", a list of orders
     * <li><b>Related Issue:</b></li> <b>F18b:</b> travelDate of the order is not correctly compered to travelDateStart of the orderInfo object,
     ...
     */
    @Test
    public void FAILING_testQueryOrdersCorrectTravelDatePassFlag() throws Exception {
        // Arrange
        QueryInfo info = new QueryInfo();
        info.setLoginId(UUID.randomUUID().toString());
        info.setEnableStateQuery(true);
     ...
     */
    @Test
    public void testQueryOrdersMultipleObjects() throws Exception {
        // Arrange
        QueryInfo[] orders = {new QueryInfo(), new QueryInfo()};
        String jsonRequest = new ObjectMapper().writeValueAsString(orders);

        // Act
        mockMvc.perform(post("/api/v1/orderOtherService/orderOther/query")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
     ...
     */
    @Test
    public void testQueryOrdersMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testQueryOrdersEmptyBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testQueryOrdersNullRequestBody() throws Exception {
        // Act
