...
@ActiveProfiles("test")
public class CreateAdminOrderTest {
     ...
     * <li><b>Expected result:</b></li> status 1, msg "Add new Order Success", the added order object
     * </ul>
     * @throws Exception
     */
    @Test
    public void testCreateAdminOrderCorrectObject() throws Exception {
        // Arrange
        ...
        // Act
        String result = mockMvc.perform(post("/api/v1/orderOtherService/orderOther/admin")
     ...
     */
    @Test
    public void testCreateAdminOrderMultipleObjects() throws Exception {
        // Arrange
        Order[] orders = {createSampleOrder(), createSampleOrder()};
        String jsonRequest = new ObjectMapper().writeValueAsString(orders);

        // Act
        mockMvc.perform(post("/api/v1/orderOtherService/orderOther/admin")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
     ...
     */
    @Test
    public void testCreateAdminOrderDuplicateObject() throws Exception {
        // Arrange
        Order order = createSampleOrder();
     ...
     */
    @Test
    public void testCreateAdminOrderMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testCreateAdminOrderEmptyBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testCreateAdminOrderNullRequestBody() throws Exception {
        // Act
