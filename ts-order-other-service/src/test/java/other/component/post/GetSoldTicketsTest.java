...
public class GetSoldTicketsTest {
    ...
    public void testGetSoldTicketsCorrectObject() throws Exception {
        ...
        // Act
        String result = mockMvc.perform(post("/api/v1/orderOtherService/orderOther/tickets")
     ...
     * no orders were found (Like status 0, msg "Seat is Null.", no data)
     * <li><b>Related Issue:</b></li> <b>F17b:</b> The implementation of the service does not handle the case
    ...
    public void FAILING_testGetSoldTicketsOrderSeatNumberNotANumber() throws Exception {
        ...
        // Act
        mockMvc.perform(post("/api/v1/orderOtherService/orderOther/tickets")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
