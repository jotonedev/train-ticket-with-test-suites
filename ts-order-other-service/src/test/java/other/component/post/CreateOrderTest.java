...
public class CreateOrderTest {
    ...
    public void testCreateOrderCorrectObject() throws Exception {
        ...
        // Act
        String result = mockMvc.perform(post("/api/v1/orderOtherService/orderOther")
    ...
    public void testCreateOrderMultipleObjects() throws Exception {
        ...
        // Act
        mockMvc.perform(post("/api/v1/orderOtherService/orderOther")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
     ...
     * <li><b>Expected result:</b></li> status 0, msg "Order already exist", the provided order
     * </ul>
     * @throws Exception
     */
    @Test
