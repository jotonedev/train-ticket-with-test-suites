...
public class QueryOrdersForRefreshTest {
     ...
     *   </ul>
     * <li><b>Parameters:</b></li> OrderInfo object with valid values for all attributes
    ...
    public void testQueryOrdersForRefreshCorrectObject() throws Exception {
        ...
        // Act
        String result = mockMvc.perform(post("/api/v1/orderOtherService/orderOther/refresh")
    ...
    public void testQueryOrdersForRefreshMultipleObjects() throws Exception {
        ...
        // Act
        mockMvc.perform(post("/api/v1/orderOtherService/orderOther/refresh")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
