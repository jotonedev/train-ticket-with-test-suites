...
public class GetOrderByIdTest {
    ...
    public void testGetOrderByIdMatchingId() throws Exception {
        ...
        // Act
        String result = mockMvc.perform(get("/api/v1/orderOtherService/orderOther/{orderId}", order.getId().toString())
    ...
    public void testGetOrderByIdMultipleId() throws Exception {
        ...
        // Act
        String result = mockMvc.perform(get("/api/v1/orderOtherService/orderOther/{orderId}", order.getId().toString(), UUID.randomUUID().toString())
                        .header(HttpHeaders.ACCEPT, "application/json"))
                .andExpect(status().isOk())
                // Assert
                .andReturn().getResponse().getContentAsString();
    ...
    public void testGetOrderByIdNonExistingId() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            mockMvc.perform(get("/api/v1/orderOtherService/orderOther/{orderId}"));
        });
    }
    ...
    public void FAILING_testGetOrderByIdIncorrectFormatId() throws Exception {
        ...
        // Act
        mockMvc.perform(get("/api/v1/orderOtherService/orderOther/{orderId}", uuid)
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
                .andExpect(status().isOk())
