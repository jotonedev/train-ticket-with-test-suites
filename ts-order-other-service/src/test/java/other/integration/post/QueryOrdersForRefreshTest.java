package other.integration.post;
...
public class QueryOrdersForRefreshTest {
    ...
    /**
     * <ul>
     * <li><b>called by ts-order-other-service:</b></li>
     *   <ul>
     ...
     * <li><b>Related Issue:</b></li> <b>F20b:</b> when the station ids are invalid, the station service will return an empty list,
