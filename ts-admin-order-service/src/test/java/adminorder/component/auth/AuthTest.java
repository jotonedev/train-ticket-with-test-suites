package adminorder.component.auth;
...
public class AuthTest {
    ...
    public void FAILING_testDeleteOrderAuthMissingAuthorization() throws Exception {
        ...
        // Act
        mockMvc.perform(delete("/api/v1/admintravelservice/adminorder/{orderId}/{trainNumber}", input, input))
                // Assert
    ...
    public void testDeleteOrderAuthUser() throws Exception {
        ...
        // Act
        mockMvc.perform(delete("/api/v1/adminorderservice/adminorder/" + input + "/" + input)
     ...
     */
    @Test
    public void FAILING_testGetAllOrdersAuthMissingAuthorization() throws Exception {
        // Act
     ...
     */
    @Test
    public void FAILING_testPostAddOrderAuthMissingAuthorization() throws Exception {
        // Assert
     ...
     */
    @Test
    public void testPostAddOrderAuthUser() throws Exception {
        // Assert
        Order order = new Order();
     ...
     */
    @Test
    public void testPostAddOrderAuthAdmin() throws Exception {
        // Assert
        Order order = new Order();
