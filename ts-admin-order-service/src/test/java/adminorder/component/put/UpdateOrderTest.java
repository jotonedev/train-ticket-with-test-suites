...
public class UpdateOrderTest {
     ...
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated order object with a train name that starts with G
     ...
     */
    @Test
    public void testUpdateOrderTrainNameStartsWithGOrderServiceSuccessful() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(put("/api/v1/adminorderservice/adminorder")
     ...
     */
    @Test
    public void testUpdateOrderMissingBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testUpdateOrderNullRequestBody() throws Exception {
        // Act
     ...
     *   <li>ts-order-service</li>
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated order object with a train name that starts with D
     * <li><b>Expected result:</b></li> The endpoint passes the response from the order service to the client, which in this case
     * is a successful response
     * </ul>
     * @throws Exception
     */
    @Test
    public void testUpdateOrderTrainNameStartsWithDOrderServiceSuccessful() throws Exception {
        // Arrange
        Order expectedOrder = generateRandomOrder();
     ...
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated order object with a train name that neither starts with G nor D
     ...
     */
    @Test
    public void testUpdateOrderTrainNameNotStartsWithDOrGOrderOtherServiceSuccessful() throws Exception {
        // Arrange
        Order expectedOrder = generateRandomOrder();
     ...
     *   <li>ts-order-service</li>
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated order object with a train name that starts with G or D
     * <li><b>Expected result:</b></li> The endpoint passes the response from the order service to the client, which in this case
     ...
     */
    @Test
    public void testUpdateOrderTrainNameStartsWithDOrGOrderServiceCrash() throws Exception {
        // Arrange
        Order expectedOrder = generateRandomOrder();
        String expectedTrainNumber = "D" + UUID.randomUUID();
        expectedOrder.setTrainNumber(expectedTrainNumber);
     ...
     */
    @Test
    public void testUpdateOrderTrainNameNotStartsWithDOrGOrderOtherServiceCrash() throws Exception {
        // Arrange
        Order expectedOrder = generateRandomOrder();
        String expectedTrainNumber = "A" + UUID.randomUUID();
        expectedOrder.setTrainNumber(expectedTrainNumber);
