...
public class InitData implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception
    {
        ...
        contactsOne.setId(UUID.fromString("5d2a46c7-71cb-4cf1-a5bb-b68406d9da6f"));
        ...
        contactsTwo.setId(UUID.fromString("6d2546c7-71cb-4cf1-a5bb-b68406d9da6f"));
    ...
    private void insertForPreserve() {
        Contacts contactsOne = new Contacts();
        contactsOne.setAccountId(UUID.fromString("4d2a46c7-71cb-4cf1-b5bb-b68406d9da61"));
        contactsOne.setDocumentType(DocumentType.ID_CARD.getCode());
        contactsOne.setName("Contacts_One");
        contactsOne.setDocumentNumber("DocumentNumber_One");
        contactsOne.setPhoneNumber("ContactsPhoneNum_One");
        contactsOne.setId(UUID.fromString("4d2a46c7-71cb-4cf1-a5bb-b68406d9da61"));
        service.createContacts(contactsOne, null);
    }
}
