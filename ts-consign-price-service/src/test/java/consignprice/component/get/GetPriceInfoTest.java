...
public class GetPriceInfoTest {
     ...
     * <li><b>Expected result:</b></li> status 1, msg "Success", a string containing the pricing details of the ConsignPrice object with index 0.
     * </ul>
     * @throws Exception
     */
    @Test
    public void testGetPriceInfoObjectInDatabase() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(get("/api/v1/consignpriceservice/consignprice/price")
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is(1)))
                .andExpect(jsonPath("$.msg", is("Success")))
                .andExpect(jsonPath("$.data", is(sb)));
    }
     ...
     */
    @Test
    public void FAILING_testGetPriceInfoMultipleConsignPriceInDatabase() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void FAILING_testGetPriceInfoNoObjectInDatabase() throws Exception {
        // Act
        mockMvc.perform(get("/api/v1/consignpriceservice/consignprice/price")
                        .header(HttpHeaders.ACCEPT, "application/json"))
                // Assert
