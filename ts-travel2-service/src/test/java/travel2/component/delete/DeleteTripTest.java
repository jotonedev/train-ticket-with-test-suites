package travel2.component.delete;
...
public class DeleteTripTest {
    ...
    public void testDeleteValidObject() throws Exception {
        ...
        // Act
        mockMvc.perform(delete("/api/v1/travel2service/trips/{tripId}", storedTrip.getTripId()))
                .andDo(print())
                // Assert
    ...
    public void testDeleteMultipleId() throws Exception {
        ...
        // Act
        mockMvc.perform(delete("/api/v1/travel2service/trips/{tripId}", storedTrip.getTripId(), UUID.randomUUID().toString()))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is(1)))
    ...
    public void testDeleteNotExists() throws Exception {
        ...
        // Act
        mockMvc.perform(delete("/api/v1/travel2service/trips/{tripId}", tripId))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
    ...
    public void testDeleteMissingId() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            mockMvc.perform(delete("/api/v1/travel2service/trips/{tripId}"));
        });
    }
    ...
    public void testDeleteMalformedURL() throws Exception {
        // Act
        mockMvc.perform(delete("/api/v1/travel2service/trips/{tripId}",UUID.randomUUID().toString() + "/" + UUID.randomUUID().toString())
