...
public class TripDetailTest {
     ...
     * As the fallback response is triggered with a 200 OK, it remains unclear whether developers deliberately omitted
     * preventative measures (e.g. null-checks) in favor of relying on the fallback (which would be considered intended behavior), or not.
     * </ul>
     * @throws Exception
     */
    @Test
