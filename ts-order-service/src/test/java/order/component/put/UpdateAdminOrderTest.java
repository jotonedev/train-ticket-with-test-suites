...
@ActiveProfiles("test")
public class UpdateAdminOrderTest {
     ...
     * <li><b>Expected result:</b></li> status 1, msg "Admin Update Order Success", the updated order.
     * </ul>
     * @throws Exception
     */
    @Test
    public void testUpdateAdminOrderCorrectObject() throws Exception {
        // Arrange
        ...
        // Act
        String result = mockMvc.perform(put("/api/v1/orderservice/order/admin")
        ...
        Assertions.assertEquals(new Response<>(1, "Admin Update Order Success", order), response);
    }
     ...
     */
    @Test
    public void testUpdateAdminOrderMultipleObjects() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testUpdateAdminOrderMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testUpdateAdminOrderEmptyBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testUpdateAdminOrderNulLRequestBody() throws Exception {
        // Act
     ...
     */
    @Test
    public void testUpdateAdminOrderMissingObject() throws Exception {
        // Arrange
        Order order = createSampleOrder();
        String jsonRequest = new ObjectMapper().writeValueAsString(order);
        ...
        mockMvc.perform(put("/api/v1/orderservice/order/admin")
                ...
                .andExpect(jsonPath("$.msg", is("Order Not Found, Can't update")))
