...
public class CreateTripTest {
     ...
     * <li><b>Related Issue:</b></li> <b>F1b:</b> The logic of the implementation is correct, but the wrong status code
     * is returned anyway.
     * @throws Exception
     */
    @Test
    public void FAILING_testCreateAlreadyExists() throws Exception {
        ...
        // Act
        mockMvc.perform(post("/api/v1/travelservice/trips")
     ...
     * <li><b>Expected result:</b></li> status 1, msg "Create trip", no data. The Trip is stored to the database.
     * </ul>
     * @throws Exception
     */
    @Test
    public void testCreateNewStationCorrectObject() throws Exception {
        // Arrange
        TravelInfo travelInfo = configureTravelInfo();
        ...
        mockMvc.perform(post("/api/v1/travelservice/trips")
                ...
                .andExpect(jsonPath("$.msg", is("Create trip:" + travelInfo.getTripId() + ".")))
                .andExpect(jsonPath("$.data", nullValue()));
