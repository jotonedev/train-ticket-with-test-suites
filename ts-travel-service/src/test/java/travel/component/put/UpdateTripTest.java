...
public class UpdateTripTest {
    ...
    public void testUpdateValidObject() throws Exception {
        ...
        // Act
        mockMvc.perform(put("/api/v1/travelservice/trips")
                ...
                .andExpect(jsonPath("$.msg", is("Update trip:" + updateTravelInfo.getTripId())))
     ...
     */
    @Test
    void testUpdateTripEmptyBody() throws Exception {
        // Act
        String requestJson = "";
        mockMvc.perform(put("/api/v1/travelservice/trips")
                        .contentType(MediaType.APPLICATION_JSON)
