...
@ActiveProfiles("test")
public class FindAllFoodOrderTest {
    @Autowired
     ...
     */
    @Test
    public void testFindAllFoodOrderElementInDatabase() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(get("/api/v1/foodservice/orders"))
                .andDo(print())
                // Assert
     ...
     */
    @Test
    public void testFindAllFoodOrderEmptyDatabase() throws Exception {
        // Act
        mockMvc.perform(get("/api/v1/foodservice/orders"))
                .andDo(print())
                // Assert
