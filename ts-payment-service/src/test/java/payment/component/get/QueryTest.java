...
public class QueryTest {
    ...
    /**
     * <ul>
     * <li><b>Tests:</b></li> that all stored Payments are returned on endpoint call
     * <li><b>Parameters:</b></li> none
     * <li><b>Expected result:</b></li> status 1, msg "Query Success", Array of all Payments
     * @throws Exception
     */
    @Test
    public void testQueryElementsInDatabase() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(get("/api/v1/paymentservice/payment"))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is(1)))
                .andExpect(jsonPath("$.msg", is("Query Success")))
