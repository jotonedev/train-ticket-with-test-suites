...
@ActiveProfiles("test")
public class DeleteAssuranceByIdTest {
     ...
     * <li><b>Parameters:</b></li> An assuranceId that matches the ID of an Assurance in the database
     * <li><b>Expected result:</b></li> status 1, msg "Delete Success with Assurance id", no data. The database no longer contains the Deleted Assurance.
     * </ul>
     * @throws Exception
     */
    @Test
    public void testDeleteAssuranceByIdCorrectObject() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(delete("/api/v1/assuranceservice/assurances/assuranceid/{assuranceId}", expectedAssuranceId))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is(1)))
                .andExpect(jsonPath("$.msg", is("Delete Success with Assurance id")))
     ...
     * <li><b>Parameters:</b></li> an element that matches the assuranceId given in paths and additional random strings
     * <li><b>Expected result:</b></li> status 1, msg "Delete Success with Assurance id", no data. The database no longer contains the Deleted Assurance.
     ...
     */
    @Test
    public void testDeleteAssuranceByIdMultipleId() throws Exception {
        // Arrange
        Assurance expectedAssurance = configureAssurance();
        assertEquals(1L, assuranceRepository.count());
        ...
        // Act
        mockMvc.perform(delete("/api/v1/assuranceservice/assurances/assuranceid/{assuranceId}", expectedAssuranceId, UUID.randomUUID().toString()))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is(1)))
     ...
     * <li><b>Parameters:</b></li> Some random assuranceId that does not match the ID of an assurance in the database
     * <li><b>Expected result:</b></li> status 1, msg "Delete Success with Assurance id", no data. The database remains unchanged.
     ...
     */
    @Test
    public void testDeleteAssuranceByIdNotExists() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testDeleteAssuranceByIdMissingId() {
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> {
            mockMvc.perform(delete("/api/v1/assuranceservice/assurances/assuranceid/{assuranceId}"));
        });
    }
     ...
     */
    @Test
    public void testDeleteAssuranceByIdMalformedURL() throws Exception {
        // Act
        mockMvc.perform(delete("/api/v1/assuranceservice/assurances/assuranceid/{assuranceId}",UUID.randomUUID() + "/" + UUID.randomUUID()))
                // Assert
     ...
     */
    @Test
    public void FAILING_testDeleteAssuranceByIdInvalidUUIDFormat() throws Exception {
        // Arrange
        String uuid = "Does not follow UUID format";

        // Act
        mockMvc.perform(delete("/api/v1/assuranceservice/assurances/assuranceid/{assuranceId}", uuid))
                .andDo(print())
                // Assert
                .andExpect(status().isOk())
