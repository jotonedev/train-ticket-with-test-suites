...
public class TicketCollectTest {
    ...
    @Test
    @Order(1)
    void testTicketCollectCorrectIdOrderService() throws  Exception {
        // Arrange
        String orderId = "5ad7750b-a67b-49c0-a8c0-32776b067701";
    ...
    @Test
    @Order(2)
    void testTicketCollectCorrectIdOrderOtherService() throws  Exception {
        // Arrange
        String orderId = "4d2a46c7-71cb-4cf1-c5bb-b68406d9da6f";
    ...
    @Test
    @Order(3)
    void testTicketCollectIdNotExists() throws  Exception {
        // Arrange
    ...
    @Test
    @Order(4)
    void testTicketCollectServiceUnavailable() throws Exception {
        // Arrange
        String orderId = "5ad7750b-a67b-49c0-a8c0-32776b067701";
