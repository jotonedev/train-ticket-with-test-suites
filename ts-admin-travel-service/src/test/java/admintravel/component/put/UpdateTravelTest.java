package admintravel.component.put;
...
public class UpdateTravelTest {
     ...
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated travel info object with a train type that starts with G
     ...
     */
    @Test
    public void testUpdateTravelTripIdStartsWithGTravelServiceSuccessful() throws Exception {
        // Arrange
        ...
        Response<Trip> travelResponse = new Response<>(1, "Update trip: ...", expectedTrip);
        ...
        // Act
        mockMvc.perform(put("/api/v1/admintravelservice/admintravel")
                ...
                .andExpect(jsonPath("$.msg", is("Update trip: ...")))
                .andExpect(jsonPath("$.data.routeId", is(expectedTrip.getRouteId())));
    }
     ...
     */
    @Test
    public void testUpdateTravelMultipleObjects() throws Exception {
     ...
     */
    @Test
    public void testUpdateTravelTripMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testUpdateTravelTripMissingBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testUpdateTravelTripNullRequestBody() throws Exception {
        // Act
     ...
     *   <li>ts-travel-service</li>
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated travel info object with a train type that starts with D
     * <li><b>Expected result:</b></li> The endpoint passes the response from the travel service to the client, which in this case
     * is a successful response
     * </ul>
     * @throws Exception
     */
    @Test
    public void testUpdateTravelTripIdStartsWithDTravelServiceSuccessful() throws Exception {
        // Arrange
        TravelInfo expectedTravelInfo = generateRandomTravelInfo();
     ...
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated travel info object with a train type that neither starts with G nor D
     ...
     */
    @Test
    public void testUpdateTravelTripIdNotStartsWithDOrGTravel2ServiceSuccessful() throws Exception {
        // Arrange
        TravelInfo expectedTravelInfo = generateRandomTravelInfo();
     ...
     *   <li>ts-travel-service</li>
     *   </ul>
     * <li><b>Parameters:</b></li> to be updated travel info object with a train type that starts with G or D
     * <li><b>Expected result:</b></li> The endpoint passes the response from the travel service to the client, which in this case
     ...
     */
    @Test
    public void testUpdateTravelTripIdStartsWithGOrDTravelServiceCrash() throws Exception {
        // Arrange
        TravelInfo expectedTravelInfo = generateRandomTravelInfo();
     ...
     */
    @Test
    public void testUpdateTravelTripIdNotyStartsWithGOrDTravel2ServiceCrash() throws Exception {
        // Arrange
        TravelInfo expectedTravelInfo = generateRandomTravelInfo();
