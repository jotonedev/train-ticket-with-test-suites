...
public class GetMinStationTest {
     ...
     */
    @Test
    public void testGetMinStationRouteServiceEmptyList() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo();

        ArrayList<RoutePlanResultUnit> emptyRoutePlanResultUnits = new ArrayList<>();
        when(restTemplate.exchange(
                ArgumentMatchers.contains("http://ts-route-plan-service:14578/api/v1/routeplanservice/routePlan/minStopStations"),
     ...
     */
    @Test
    public void testGetMinStationRouteServiceNonEmptyList() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo();
     ...
     */
    @Test
    public void testGetMinStationMultipleObjects() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testGetMinStationMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testGetMinStationEmptyBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testGetMinStationNullRequestBody() throws Exception {
        // Act
