...
public class GetCheapestTest {
     ...
     */
    @Test
    public void testGetCheapestRouteServiceEmptyList() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo();

        ArrayList<RoutePlanResultUnit> emptyRoutePlanResultUnits = new ArrayList<>();
        when(restTemplate.exchange(
                ArgumentMatchers.contains("http://ts-route-plan-service:14578/api/v1/routeplanservice/routePlan/cheapestRoute"),
        ...
        // Act
        mockMvc.perform(post("/api/v1/travelplanservice/travelPlan/cheapest")
     ...
     */
    @Test
    public void testGetCheapestRouteServiceNonEmptyList() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo();
     ...
     */
    @Test
    public void testGetCheapestMultipleObjects() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testGetCheapestMalformedObject() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void testGetCheapestEmptyBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testGetCheapestNullRequestBody() throws Exception {
        // Act
