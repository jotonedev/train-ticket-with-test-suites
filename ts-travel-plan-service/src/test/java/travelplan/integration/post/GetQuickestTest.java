...
public class GetQuickestTest {
    ...
    @Test
    @Order(1)
    public void FAILING_testGetQuickestFullyValidRequestBody() throws Exception {
        // Arrange
    ...
    @Test
    @Order(3)
    public void testGetQuickestNoStationsExist() throws Exception {
        // Arrange
    ...
    @Test
    @Order(4)
    public void testGetQuickestDepartureTimeFromPast() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo("Shang Hai", "Tai Yuan");
    ...
    @Test
    @Order(5)
    public void testGetQuickestUnavailableService() throws Exception {
        // Arrange
