...
public class GetCheapestTest {
    ...
    @Test
    @Order(1)
    public void FAILING_testGetCheapestFullyValidRequestBody() throws Exception {
        // Arrange
     ...
     * <li><b>Expected result:</b></li> status 0, msg "Cannot Find", not data
     * </ul>
     * @throws Exception
     */
    @Test
    @Order(3)
    public void testGetCheapestNoStationsExist() throws Exception {
        // Arrange
    ...
    @Test
    @Order(4)
    public void testGetCheapestDepartureTimeFromPast() throws Exception {
        // Arrange
        TripInfo tripInfo = configureTripInfo("Shang Hai", "Tai Yuan");
    ...
    @Test
    @Order(5)
    public void testGetCheapestUnavailableService() throws Exception {
        // Arrange
