...
public class PayDifferenceTest {
    ...
    public void testPayDifferenceCorrectObject() throws Exception {
        ...
        rebook.entity.Order order = new rebook.entity.Order();
        order.setId(id);
        order.setStatus(1);
        ...
        uri = UriComponentsBuilder.fromUriString("http://ts-inside-payment-service:18673/api/v1/inside_pay_service/inside_payment/difference").build().toUri();
        mockServer.expect(ExpectedCount.once(), requestTo(uri))
                .andExpect(method(HttpMethod.POST))
     ...
     */
    @Test
    public void testPayDifferenceMissingBody() throws Exception {
        // Arrange
        String requestJson = "";
     ...
     */
    @Test
    public void testPayDifferenceLoginIdNonExisting() throws Exception {
        // Arrange
        // Mock responses of external services for every request this service does for the endpoint
        UUID id = UUID.randomUUID();
        rebook.entity.Order order = new rebook.entity.Order();
        ...
        Response<rebook.entity.Order> mockResponse1 = new Response<>(1, "Success", order);
        URI uri = UriComponentsBuilder.fromUriString("http://ts-order-other-service:12032/api/v1/orderOtherService/orderOther/1").build().toUri();
        mockServer.expect(ExpectedCount.once(), requestTo(uri))
                .andExpect(method(HttpMethod.GET))
                .andRespond(withSuccess(objectMapper.writeValueAsString(mockResponse1), MediaType.APPLICATION_JSON));
     ...
     * <li><b>Expected result:</b></li> status 0, msg "Not exists", no data. The message is forwarded from the order service
     * </ul>
     * @throws Exception
     */
    @Test
    public void testPayDifferenceOrderIdNonExisting() throws Exception {
        // Arrange
        Response<rebook.entity.Order> mockResponse1 = new Response<>(0, "Not exists", new rebook.entity.Order());
        URI uri = UriComponentsBuilder.fromUriString("http://ts-order-other-service:12032/api/v1/orderOtherService/orderOther/1").build().toUri();
        mockServer.expect(ExpectedCount.once(), requestTo(uri))
                .andExpect(method(HttpMethod.GET))
                .andRespond(withSuccess(objectMapper.writeValueAsString(mockResponse1), MediaType.APPLICATION_JSON));
     ...
     */
    @Test
    public void testPayDifferenceTripIdNonExisting() throws Exception {
        // Arrange
        // Mock responses of external services for every request this service does for the endpoint
        UUID id = UUID.randomUUID();
        rebook.entity.Order order = new rebook.entity.Order();
        ...
        Response<TripAllDetail> mockResponse3 = new Response<>(0, "Not exists", null);
        uri = UriComponentsBuilder.fromUriString("http://ts-travel-service:12346/api/v1/travelservice/trip_detail").build().toUri();
        mockServer.expect(ExpectedCount.once(), requestTo(uri))
                .andExpect(method(HttpMethod.POST))
                .andRespond(withSuccess(objectMapper.writeValueAsString(mockResponse3), MediaType.APPLICATION_JSON));
     ...
     */
    @Test
    public void testPayDifferenceTripIdSameType() throws Exception {
        // Assert
        // Mock responses of external services for every request this service does for the endpoint
        UUID id = UUID.randomUUID();
        rebook.entity.Order order = new rebook.entity.Order();
     ...
     */
    @Test
    public void testPayDifferenceSeatTypeInvalid() throws Exception {
        // Arrange
        // Mock responses of external services for every request this service does for the endpoint
        UUID id = UUID.randomUUID();
        rebook.entity.Order order = new rebook.entity.Order();
