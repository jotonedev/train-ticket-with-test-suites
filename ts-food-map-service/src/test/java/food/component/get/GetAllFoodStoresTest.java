...
@ActiveProfiles("test")
public class GetAllFoodStoresTest {
    ...
    /**
     * <ul>
     * <li><b>Tests:</b></li> that all stored FoodStores are returned on endpoint call
     * <li><b>Parameters:</b></li> none
     * <li><b>Expected result:</b></li> status 1, msg "Success", Array of all FoodStores
     * @throws Exception
     */
    @Test
    public void testGetAllFoodStoresElementInDatabase() throws Exception {
        ...
        // Act
        mockMvc.perform(get("/api/v1/foodmapservice/foodstores"))
                .andDo(print())
                // Assert
